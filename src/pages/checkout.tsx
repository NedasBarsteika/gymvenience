...
interface ShippingOption {
  ...
  value: string;
  price: number;
  image: string; // shipping provider’s logo
}
...
function CheckoutPage() {
  ...
  const handleQuantityTyping = (id: number, rawValue: string) => {
    ...
    if (isNaN(num) || num < 1) {
      num = 1; // or remove the item if you prefer
    }
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-grow container mx-auto p-4">
        <h1 className="text-3xl font-bold mb-4">Atsiskaitymas</h1>
        {cartItems.length === 0 ? (
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2 mt-1">
                        ...
                        {/* Input always shows cart’s real quantity */}
                        <input
                          type="number"
